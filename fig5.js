function fig5() {
    ...
    sup_brace_x1 = -10;
    sup_brace_x2 = brace_x1 - spacing;
    sup_brace_xmid = (sup_brace_x1 + sup_brace_x2) / 2;
    brace = delayed_legend.append("path")
        .attr("d", makeCurlyBrace(sup_brace_x1, brace_y, sup_brace_x2, brace_y, 25, 0.62))
        .attr("stroke", "black")
        .attr("stroke-width", 2)
        .attr("fill", "none")
    brace_text = delayed_legend.append("text")
        .attr("x", sup_brace_xmid)
        .attr("y", labelY + 100)
        .attr("text-anchor", "middle")
        .attr("dominant-baseline", "middle")
        .style("font-size", "20px")
        .text(`Supervised data`);


    // Show the Naive / Augmented braces above the timeline
    // Naive
    naive_brace_x1 = -10;
    naive_brace_x2 = brace_x1 - spacing;
    naive_brace_xmid = (naive_brace_x1 + naive_brace_x2) / 2;
    naive_brace_y = baseY - 10;
    brace = delayed_legend.append("path")
        .attr("d", makeCurlyBrace(naive_brace_x1, naive_brace_y, naive_brace_x2, naive_brace_y, -25, 0.62))
        .attr("stroke", "black")
        .attr("stroke-width", 2)
        .attr("fill", "none")
    brace_text = delayed_legend.append("text")
        .attr("x", naive_brace_xmid)
        .attr("y", naive_brace_y - 40)
        .attr("text-anchor", "middle")
        .attr("dominant-baseline", "middle")
    ...
    // Augmented
    aug_brace_x1 = -10;
    aug_brace_x2 = brace_x2;
    aug_brace_xmid = (aug_brace_x1 + aug_brace_x2) / 2;
    aug_brace_y = baseY - 70;

    brace = delayed_legend.append("path")
        .attr("d", makeCurlyBrace(aug_brace_x1, aug_brace_y, aug_brace_x2, aug_brace_y, -25, 0.62))
        .attr("stroke", "black")
        .attr("stroke-width", 2)
        .attr("fill", "none")
    brace_text = delayed_legend.append("text")
        .attr("x", aug_brace_xmid)
        .attr("y", aug_brace_y - 40)
        .attr("text-anchor", "middle")
        .attr("dominant-baseline", "middle")
        .style("font-size", "25px")
        .text(`Augmented`);
